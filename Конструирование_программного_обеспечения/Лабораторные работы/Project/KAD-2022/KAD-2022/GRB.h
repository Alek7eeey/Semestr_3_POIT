...
namespace GRB
{
	struct Rule //правило в грамматике Грейбах
	{
		...
		int iderror; //индентифекатор диагностического сообщения
		...
		struct Chain	//цепочка(правая часть правила)
		{
			...
			Chain(
				short symbolCount, //кол-во символов в цепочке
		...
		short getNextChain(	//получить следующую за jодходящую цепочку, вернуть её номер или -1
