...
{
	setlocale(LC_ALL, "ru");
	cout << "¬ведите размер попул€ций: "; cin >> populationSize;
	cout << "¬ведите количество потомков в одной попул€ции: "; cin >> child;
	cout << "¬ведите количество эволюционных циклов: "; cin >> evoCount;
	TSPUtil(map);
}
